...
\item[Product Law]  $\displaystyle\lim_{x\to a} (f(x)g(x)) = \lim_{x\to
...
\begin{explanation}
      ...
      \[
      \displaystyle\frac{\lim_{x\to a} f(x)}{ \lim_{x\to a} g(x)}
      \]
...
and
    ...
    \begin{align*}
      \displaystyle\lim_{x\to 4}\frac{8}{x-4}=\frac{\lim_{x\to 4}8}{\lim_{x\to 4}(x-4)}
    \end{align*}
