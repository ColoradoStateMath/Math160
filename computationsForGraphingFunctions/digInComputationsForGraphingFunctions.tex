...
\begin{explanation}
 ...
 Try this on your own first, then either check with a friend, a graphing calculator (like \href{www.desmos.com}) or check the online version.
...
\begin{tikzpicture}
	\begin{axis}[
           ...
           \addplot [->, line width=4, penColor!10!background] plot coordinates {(-5,2) (-1,1.5)}; 
            \addplot [->, line width=4, penColor!10!background] plot coordinates {(-1,1.5) (0,2)}; 
...
On $(-\infty, 0)$, $f''$ has one zero, namely $x = \answer[given]{-\sqrt{3}}$.  The sign of $f''$ changes from \wordChoice{\choice{positive to negative} \choice[correct]{negative to positive}]} through this point.
