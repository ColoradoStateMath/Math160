...
\[
Y'(z)
=\answer{-4z+\frac{1}{5 \sqrt[5]{z}^4}-3 \cos (z)}
\]
\end{exercise}
...
\[
f'(x)
=\answer{15x^4-\frac{1}{3 \sqrt[3]{x}^4}+3 \sin(x))}
\]
\end{exercise}
...
\[
\dd{v}R(v)
=\answer{\left(\sqrt{v}-\frac{2}{\sqrt[4]{v}}\right) \left(\frac{20}{v^6}+3 \cos (v)\right)+\left(\frac{1}{2 \sqrt[4]{v}^5}+\frac{1}{2 \sqrt{v}}\right) \left(3 \sin (v)-\frac{4}{v^5}\right)}
\]
\end{exercise}
...
\[
p'(n)
=\answer{\left(\frac{1}{\sqrt[4]{n}^5}-\frac{2}{5 \sqrt[5]{n}^4}\right) \left(3 n^4-2 \sin (n)\right)+\left(-2 \sqrt[5]{n}-\frac{4}{\sqrt[4]{n}}\right) \left(12 n^3-2 \cos (n)\right)}
\]
\end{exercise}
...
\[
C'(t)
=\answer{\frac{\sqrt{t}-\frac{3}{\sqrt[4]{t}}}{4 t^{3/2}}-\frac{\frac{3}{4 \sqrt[4]{t}^5}+\frac{1}{2 \sqrt{t}}}{2 \sqrt{t}}}
\]
\end{exercise}
