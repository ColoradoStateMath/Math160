...
%%basic Deriv rules 3
\begin{exercise}
Let $Y(z) = -2 z^2 + (z)^(1/5) -3 \sin (z)$. Compute:
...
=======
=\answer{-4z+\frac{1}{5 {z}^(4/5)}-3 \cos (z)}
>>>>>>> 41ac19f5fece2cc0cc4437a77769a12389b4e2f5
\]
\end{exercise}
...
\begin{exercise}
Let $f(x) = 3x^5+\frac{1}{(x)^(1/3)-3 \cos (x)$. Compute:

\begin{hint}
Rewrite $\frac{1}{x^(1/3)}$ as $x^{-1/3}$.
\end{hint}
\[
f'(x)
<<<<<<< HEAD
...
=======
=\answer{\left(\frac{1}{{n}^(5/4)}-\frac{2}{5 {n}^(4/5)}\right) \left(3 n^4-2 \sin (n)\right)+\left(-2 {n}^(1/5)-\frac{4}{{n}^(1/4)}\right) \left(12 n^3-2 \cos (n)\right)}
>>>>>>> 41ac19f5fece2cc0cc4437a77769a12389b4e2f5
\]
\end{exercise}
...
\begin{exercise}
Let $C(t) = \frac{ \sqrt{t}-\frac{3}{{t}^(1/4)}}{-2 \sqrt{t}}$. Compute:
\[
C'(t)
<<<<<<< HEAD
=\answer{\frac{\sqrt{t}-\frac{3}{{t}^(1/4)}}{4 t^{3/2}}-\frac{\frac{3}{4 {t}^(4/5)}+\frac{1}{2 \sqrt{t}}}{2 \sqrt{t}}}
=======
=\answer{\frac{\sqrt{t}-\frac{3}{{t}^(1/4)}}{4 t^{3/2}}-\frac{\frac{3}{4 {t}^(5/4)}+\frac{1}{2 \sqrt{t}}}{2 \sqrt{t}}}
>>>>>>> 41ac19f5fece2cc0cc4437a77769a12389b4e2f5
\]
\end{exercise}
