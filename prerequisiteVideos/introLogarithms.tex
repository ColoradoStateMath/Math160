...
%% Question 4
\textbf{Question 4: Logarithms, fractions, and reciprocals.}
\begin{question}
%% Labeling this expandable option
\begin{flushright}
...
\begin{center}
$\log_2(56)$ can be written as a sum of $\answer[given]{1}$ term(s) $n\log_2(p)$ (where the $p$'s are distinct primes) and a constant integer.
\end{center}
\begin{prompt}
\[
