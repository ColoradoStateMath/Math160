...
posed at the end of the video.})}
\begin{expandable}
What are all solutions to $6\cos^2(\theta) - 3 = 0$? (Select all correct answers, if applicable.)
\begin{selectAll}
\choice{$0 + 2\pi n$ for integers}
\choice[correct]{$\frac{\pi}{6} + 2\pi n$ for all integers $n$}
...
\choice[correct]{$\frac{5\pi}{6} + 2\pi n$ for all integers $n$}
\choice{$\pi + 2\pi n$ for all integers $n$}
\choice[correct]{$\frac{7\pi}{6} + 2\pi n$ for all integers $n$}
...
\choice[correct]{$\frac{11\pi}{6} + 2\pi n$ for all integers $n$}
\choice{There is no way to find all of the solutions.}
