...
to the question posed at the end of the video.})}
\begin{expandable}
Which of the following ways does $x^2+16$ factor?
\begin{multipleChoice}
\choice{$(x+4)(x-4)$}
\choice{$(x-4)^2$}
\choice{$(x+4)^2$}
\choice[correct]{It doesn't factor}
\end{multipleChoice}
%% Example 3
\begin{flushright}
{\color{blue}(\emph{Click the arrow to the right to see an example.})}
...
%% Question 5
\textbf{Question 5: Polynomial Long Division}
\begin{question}
%% Labeling this expandable option
\begin{flushright}
...
%% Question 6
\textbf{Question 6: Imaginary Roots}
\begin{question}
%% Labeling this expandable option
\begin{flushright}
...
\begin{expandable}
Need Synthetic Division Intro Video
%\youtube{}
\end{expandable}
%% Question 7
\textbf{Question 7: Synthetic Long Division}
\begin{question}
%% Labeling this expandable option
\begin{flushright}
