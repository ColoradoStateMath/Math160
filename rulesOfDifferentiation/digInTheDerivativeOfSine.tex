...
\begin{theorem}[The derivative of cosine]\index{derivative!of cosine}\label{theorem:deriv cos}
...
\]
Now we get sneaky and apply the trigonometric addition formula for cosine, that says $\cos(\alpha+\beta) = \cos(\alpha)\cos(\beta)-\sin(\beta)\sin(\alpha)$, to write
\begin{align*}
